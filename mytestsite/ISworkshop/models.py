...
class Company(models.Model):
    company_email = models.EmailField(
			verbose_name="company_email", max_length=60, unique=True)
    phone_number = models.CharField(
			verbose_name="phone_number", max_length=9, unique=True)
    company_name = models.CharField(
			verbose_name="company_name", max_length=60, blank=False)
